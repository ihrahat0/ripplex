                ...
                <div className="col-xl-6 col-md-12">
                    ...
                    <div className="swiper swiper-thumb1">
                        ...
                        <div className="swiper-slide">
                            <img src={avt1} alt="Ripple Exchange" />
                        </div>
                        <div className="swiper-slide">
                            <img src={avt2} alt="Ripple Exchange" />
                        </div>
                        <div className="swiper-slide">
                            <img src={avt3} alt="Ripple Exchange" />
                        </div>
                        </div>
                    </div>
                        ...
                        data.map(idx => (
                            <SwiperSlide key={idx.id}>
                                <div className="testimonials-box">
                                    ...
                                    <div className="info">
                                        <img src={idx.avt} alt="Ripple Exchange" />
                                        <div className="content">
                                        <h6 className="name">{idx.name}</h6>
                                        <p className="position">{idx.position}</p>
                                        </div>
                                    </div>
                                    <img src={idx.partner} alt="Ripple Exchange" />
                                    </div>
                                </div>
                            </SwiperSlide>
